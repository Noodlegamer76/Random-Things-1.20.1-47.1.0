...
public enum ArmorTiers implements StringRepresentable, ArmorMaterial {
    LEATHER("cactus", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
    ...
    private ArmorTiers(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionFunctionForType, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
